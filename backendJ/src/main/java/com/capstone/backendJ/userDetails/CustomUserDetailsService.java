...
import com.capstone.backendJ.user.UserRepository;
...
public class CustomUserDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) {
    	...
    	try {
	    	...
	    	com.capstone.backendJ.user.User user = userRepo.findByUserName(username);
	...
	public void createUser(com.capstone.backendJ.user.User addedUser) {
		userDetailsRepo.save(new com.capstone.backendJ.userDetails.UserDetails(addedUser.getUsername(), addedUser.getEmail()));
	}
